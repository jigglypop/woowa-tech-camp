...
// // lazy인지
// const isLazy = (text) => {
//   const result = isMatch(lazy, text);
//   return result;
// };
// // 여는 태그
// const isOpen = (text) => {
//   const result = isMatch(open, text);
//   return result;
// };
// const isClose = (text) => {
//   const result = isMatch(close, text);
//   return result;
// };
// const isComponent = (text) => {
//   const result = isMatch(component, text);
//   return result;
// };
// const isWhich = (dom) => {
//   if (isLazy(dom)) {
...
//   }
// };
// console.log(isWhich('<div class="AppOuter" >'));
